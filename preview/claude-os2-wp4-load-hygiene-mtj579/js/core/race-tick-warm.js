...
(function(){
  ...
  window._warmRaceTick = function _warmRaceTick(){
    ...
    // WP4 rang 7 — sub-spans zodat de headless harnas (goToRace.*-filter in
    // bench.mjs) de kost bínnen warmRaceTick kan attribueren: update-whitelist
    // vs mirror-render vs chase-render. Pure meting, geen gedragswijziging.
    if(window.perfMark)perfMark('goToRace:wrt:updates:start');
