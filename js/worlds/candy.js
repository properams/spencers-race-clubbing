...
function buildCandyBarriers(){
  ...
  // Fix-sessie 1 (audit rang 1): uitgelijnd met de _isLowDensity-gate op de
  // cluster-lights hierboven — desktop-low bouwde hier nog 48 PointLights
  // terwijl de emissive lamp-heads het beeld dragen.
  const skipPointLights = !!window._isMobile || (typeof window._isLowDensity==='function' && window._isLowDensity());
  let idx = 0;
